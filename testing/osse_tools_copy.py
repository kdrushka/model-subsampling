...
def setup_earthdata_login_auth(endpoint: str='urs.earthdata.nasa.gov'):
    """
    Helps logging into the earthdata login account. Please make sure that the earthdata account is set up.

    Parameters
    ----------
    first : url like
            It collects the earthdata login details.


    Returns
    -------
    Opens a dialog box for the user which can be used to enter the login details
